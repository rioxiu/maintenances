<div class="container-fluid">
	<? //= var_dump($detail);die; 
	?>
	<h1 class="h3 mb-3 text-gray-800 font-weight-bold"><?= lang(line: "ticket_detail_title")?> #<?= $detail['id_ticket'] ?></h1>

	<ul class="nav nav-tabs" id="myTab" role="tablist">
		<li class="nav-item" role="presentation">
			<a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true"><?= lang(line: "ticket_detail_title")?></a>
		</li>
		<li class="nav-item" role="presentation">
			<a class="nav-link" id="lacak-tab" data-toggle="tab" href="#lacak" role="tab" aria-controls="lacak" aria-selected="false"><?= lang(line: "ticket_detail_tab_sistemlacak")?></a>
		</li>
		<li class="nav-item" role="presentation">
									...
									<div class="card-header" id="headingOne">
										<h2 class="mb-0">
											<button class="btn btn-link btn-block text-left font-weight-bold" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
												<i class="fas fa-pencil-alt"></i> <?= lang(line: "ticket_detail_reply")?>
											</button>
										</h2>
									</div>
										...
										<div class="card-body">
											<form action="<?= site_url('ticket_user/submitMessage/' . $detail['id_ticket']) ?>" method="post" enctype="multipart/form-data">
												<div class="form-group">
													<label for="message"><?= lang(line: "ticket_detail_reply_message")?></label>
												...
												<div class="form-group">
													<label class="mb-1 font-weight-bold"><?= lang(line: "ticket_detail_attachment")?></label> </br>
													<p class="small mb-3"><?= lang(line: "ticket_detail_attachment_subtitle")?></p>
												...
												<div class="form-group">
													<button type="submit" class="btn btn-primary"><?= lang(line: "ticket_detail_reply_send")?></button>
												</div>
											</form>
										</div>
									</div>
					...
					foreach ($tracking as $row) { ?>
						...
						<div class="tracking-item">
							...
							<div class="tracking-content">
								...
								<h4 class="small font-weight-bold"><?= lang(line: "ticket_detail_ticket_progress")?>: <?= $row->nama ?></h4>
								<?php if ($row->filefoto != "") { ?>
									...
									<?php } else { ?>
										...
										<?= lang(line: "click_to_zoom")?> <i class="fas fa-search-plus"></i>
									<?php } ?>
								<?php } else {
