<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow-sm navbar-fixed-top">
	...
	<button class="btn rounded border-0 font-weight-bold text-dark" id="sidebarToggle"><i
			class="fas fa-bars fa-lg"></i></button>

	<ul class="navbar-nav ml-auto">
		<?php if ($this->session->userdata('level') == "Admin"): ?>
			<li class="nav-item dropdown no-arrow mx-1">
				<a class="nav-link dropdown-toggle text-dark" href="javascript:void(0)" id="alertsDropdown" role="button"
		...
		<li class="nav-item dropdown no-arrow">
			...
			<div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
				...
				<a class="dropdown-item py-2" href="#modal-stok" data-toggle="modal"> <i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-black-100"></i>
					<?= lang('menu_logout'); ?>
				</a>
		...
		<li class="nav-item dropdown no-arrow">
			<a class="nav-link dropdown-toggle text-dark" href="javascript:void(0)" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				<i class="fas fa-globe fa-sm fa-fw mr-2 text-black-100"></i>
				<span class="mr-2 d-none d-lg-inline text-gray-700">
			...
			<div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
				<a class="dropdown-item py-2" href="<?= site_url('language/switch/english'); ?>">
					Indonesia
				</a>
				<a class="dropdown-item py-2" href="<?= site_url('language/switch/chinese'); ?>">
