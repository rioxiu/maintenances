...
Toko Online: IT Helpdesk (Tokopedia.com/itshoppwt, Shopee.co.id/itshoppwt, Bukalapak.com/itshoppwt)
...
class Dashboard extends MY_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->session->userdata('level') == "Admin") {
            ...
            // dashboard Viewer (untuk purchasing)
        } else if ($this->session->userdata('level') == "Viewer"){
            $data['body']= "dashboard/dashboard_viewer";
        }
