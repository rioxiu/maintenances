...
<body class="bg-primary"
	style="background: url('<?= base_url('assets/img/') . $this->settings->info['background']; ?>') no-repeat center center fixed;-webkit-background-size: cover;-moz-background-size: cover;-o-background-size: cover;background-size: cover;">
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-md-5">
					...
					<div class="card-body p-0">
						<div class="row">
							<div class="col-lg">
								<div class="p-3 m-3">
									<div>
										<h2 class="h5 font-weight-bold text-center text-dark">
											<?= $this->settings->info['perusahaan']; ?>
										</h2>
										<h1 class="h2 font-weight-bold text-center push-top-bottom animation-slideDown"
											style="color: black">
											<img src="<?= base_url('assets/img/') . $this->settings->info['logo']; ?>"
												width="50">
										...
										<?php if ($this->session->flashdata('status')): ?>
											<div class="alert alert-danger alert-dismissable">
												...
												<strong>Error!</strong> Username atau Password
										...
										<?php if ($this->session->flashdata('status1')): ?>
											<div class="alert alert-info alert-dismissable">
												<button type="button" class="close" data-dismiss="alert"
													aria-hidden="true">&times;</button>
												Sesi Anda telah
												<strong><?= $this->session->flashdata('status1'); ?></strong>! Silahkan
										...
										<form action="<?= site_url('login/loginProses') ?>" method="post">
											<div class="form-group">
												<input type="text" name="username"
													...
													placeholder="Username/Email/Telepon" autofocus>
											...
											<button type="submit"
												class="btn btn-primary btn-lg btn-user btn-block">Login</button>
										</form>
									</div>
								</div>
							</div>
				...
				<p class="text-center text-white mt-3 small">
					&copy; 2022-<?= date('Y'); ?> <?= $this->config->item('site_company'); ?>. Software
					<?= $this->config->item('site_name'); ?> <?= $this->config->item('site_version'); ?>.<br />All
					rights reserved
				</p>
			</div>
		</div>
