					...
					<tbody>
						...
						foreach ($subkat as $row) { ?>
							<tr>
								...
								<td>
									<a href="<?= site_url('subkategori/edit/' . $row->id_sub_kategori) ?>"
										data-toggle="tooltip" title="Edit <?= $title; ?>"
										class="btn btn-primary btn-circle btn-sm mr-2"><i class="fa fa-edit"></i>
									</a>
									<a href="<?= site_url('subkategori/hapus/' . $row->id_sub_kategori) ?>"
										data-toggle="tooltip" title="Hapus <?= $title; ?>"
										class="btn btn-danger btn-circle btn-sm hapus"><i class="fas fa-trash"></i>
									</a>
								</td>
							</tr>
							<?php $no++;
			...
			<div class="modal-body">
				<form id="form-validation" action="<?= site_url('subkategori/tambah') ?>" method="POST">
					...
					<div class="form-group">
						...
						<input class="form-control <?= (form_error('nama_sub_kategori') ? "is-invalid" : "") ?>"
							name="nama_sub_kategori" placeholder="">
